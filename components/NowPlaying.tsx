    ...
    <div className="flex flex-col items-center justify-center text-center p-4 space-y-2 min-h-[120px]">
      <AnimatePresence mode="wait">
        {currentSong ? (
          ...
          >
            {currentPlaylist && (
              <span className="text-xs font-semibold px-3 py-1 bg-white/10 text-purple-300 rounded-full backdrop-blur-md mb-2">
                {currentPlaylist.name}
              </span>
            )}
            <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-300 truncate w-full px-4">
              {currentSong.title}
            </h1>
